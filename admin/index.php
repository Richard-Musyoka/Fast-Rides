...
<html lang="en">
	<head>
		...
		<link rel="icon" type="image/png" sizes="16x16" href="Uploads/images/favicon.ico">
	...
	<body style="background-image: url(Uploads/images/back1.jpg);">
		<div class="login">
		...
		<footer class="sticky-footer bg-white">
			<div class="container my-auto">
		  		<div class="copyright text-center my-auto">
					<span>Copyright &copy; Fast  Car Rides  Website by THOMAS KILUU 2021</span>
		  		</div>
			</div>
	  	</footer>
		<!-- End of Footer -->
